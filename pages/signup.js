...
import { STRIPE_PUBLISHABLE_KEY } from '../src/public-env-vars';
...
export default class Signup extends Component {
  ...
  signup(plan, token) {
    fetch('/create-account', {
      ...
      console.error(er);
      alert('There was an error creating your account, please contact support@user-agent.io')
    });
  }
        ...
        <main>
          ...
          <section className="jumbotron">
            <div className="container">
              ...
              <p>Sign up to get a simple link that you can give to someone else and then you can see their user-agent as
                soon as they click it.</p>
            </div>
          </section>
              ...
              <div className="card">
                ...
                <div className="card-block">
                  ...
                  <StripeCheckout
                    ...
                    token={(token) => {console.log(token); this.signup('basic', token)}}
                    name="User-Agent.io"
                    description="Basic Subscription ($5 per month)"
                    panelLabel="Try it FREE for 30 days"
                    label="Try it FREE"
