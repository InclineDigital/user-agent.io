  ...
  <Layout title="See Someone Else's User-Agent">
    <main>
      ...
      <section className="container">
          ...
          <div className="card">
            ...
            <img className="card-img-top" src="..." alt="Card image cap"> */ }
              <div className="card-block">
                ...
                <ul>
                  <li>Get a customizable link that you can share with your users.
                    When they click it, you will instantly see their user-agent.</li>
        ...
        <p>🖥 Need even more users? More history? White-labeling? On-prem deployment? <a href="mailto:sales@user-agent.io?subject=Enterprise%20Account&body=Hi%2C%20I'm%20interested%20in%20an%20enterprise%20account%20for%20user-agent.io%2C%20my%20business%20needs...
">Contact us today about an enterprise plan</a>.</p>
      </section>
    </main>
  </Layout>
)
