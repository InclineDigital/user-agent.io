    ...
    <main>
      ...
      <section className="container">
        ...
        <ul>
          ...
          <li>
            If something is missing or wrong, or you have any other ideas for improving the site, please
            {' '}
            <a href="https://github.com/nfriedly/user-agent.io">send an issue or pull request on Github <i className="fa fa-github" /></a>
            .
          </li>
        </ul>
